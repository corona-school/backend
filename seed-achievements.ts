...
export async function importAchievements() {
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            actionRedirectLink: 'https://calendly.com/lern-fair/huh-kennenlernen?email={{email}}',
            actionType: achievement_action_type_enum.Action,
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            subtitle: 'Du hast {{progress}} Woche(n) in Folge mit {{partner.firstname}} gelernt!',
            footer: 'Noch {{remainingProgress}} Woche(n) in Folge lernen bis zum neuen Rekord!',
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            subtitle: 'Du warst {{progress}} Termine(n) in Folge pünktlich!',
            footer: 'Noch {{remainingProgress}} mal pünktlich sein bis zum neuen Rekord!',
            achievedFooter: 'Hurra, du erhöhst deinen Rekord weiter!',
            description:
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            subtitle: 'Du hast dich {{progress}} Monat(e) in Folge angemeldet!',
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            actionName: 'Termin buchen',
            actionRedirectLink: 'https://calendly.com/schueler-screening/willkommen-bei-lern-fair?email={{email}}',
            actionType: achievement_action_type_enum.Action,
    ...
    await prisma.achievement_template.create({
        data: {
            ...
            subtitle: null,
            footer: 'Du hast den Erfolg abgeschlossen!',
            achievedFooter: null,
            description:
