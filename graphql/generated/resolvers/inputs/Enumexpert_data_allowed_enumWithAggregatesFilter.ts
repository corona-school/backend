...
import { NestedEnumexpert_data_allowed_enumWithAggregatesFilter } from "../inputs/NestedEnumexpert_data_allowed_enumWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { expert_data_allowed_enum } from "../../enums/expert_data_allowed_enum";

@TypeGraphQL.InputType("Enumexpert_data_allowed_enumWithAggregatesFilter", {
  isAbstract: true
})
export class Enumexpert_data_allowed_enumWithAggregatesFilter {
