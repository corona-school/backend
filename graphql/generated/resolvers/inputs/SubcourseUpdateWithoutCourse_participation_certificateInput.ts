...
@TypeGraphQL.InputType("SubcourseUpdateWithoutCourse_participation_certificateInput", {
  isAbstract: true
})
export class SubcourseUpdateWithoutCourse_participation_certificateInput {
