...
@TypeGraphQL.InputType("NestedEnumstudent_registrationsource_enumWithAggregatesFilter", {
  isAbstract: true
})
export class NestedEnumstudent_registrationsource_enumWithAggregatesFilter {
