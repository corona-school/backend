...
import { NestedEnumnotification_sender_enumNullableWithAggregatesFilter } from "../inputs/NestedEnumnotification_sender_enumNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { notification_sender_enum } from "../../enums/notification_sender_enum";

@TypeGraphQL.InputType("Enumnotification_sender_enumNullableWithAggregatesFilter", {
  isAbstract: true
})
export class Enumnotification_sender_enumNullableWithAggregatesFilter {
