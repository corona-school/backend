...
@TypeGraphQL.InputType("Course_participation_certificateUpdateManyWithWhereWithoutPupilInput", {
  isAbstract: true
})
export class Course_participation_certificateUpdateManyWithWhereWithoutPupilInput {
