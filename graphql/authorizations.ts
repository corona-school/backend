...
export const authorizationEnhanceMap: Required<ResolversEnhanceMap> = {
    Appointment_participant_student: allAdmin,
    Appointment_participant_screener: allAdmin,
    Appointment_participant_pupil: allAdmin,
    Appointment_organizer: allAdmin,
    Course: allAdmin,
    Pupil: allAdmin,
    Match: allAdmin,
    Lecture: allAdmin,
...
export const authorizationModelEnhanceMap: ModelsEnhanceMap = {
    ...
    Pupil: {
        ...
        >({
            ...
            appointment_participant_pupil: nobody,
            match: nobody,
            _count: nobody,
        }),
    },
    ...
    Student: {
        ...
        >({
            ...
            appointment_organizer: nobody,
            appointment_participant_student: nobody,
            _count: nobody,
        }),
    },
    Subcourse: {
    ...
    Lecture: {
        fields: withPublicFields<Lecture, 'id' | 'start' | 'duration' | 'createdAt' | 'updatedAt' | 'title' | 'description' | 'isCanceled' | 'appointmentType'>(
            {
                course_attendance_log: nobody,
                ...
                student: nobody,
                instructorId: nobody,
                appointment_participant_student: adminOrOwner,
                appointment_participant_screener: adminOrOwner,
                appointment_participant_pupil: adminOrOwner,
                appointment_organizer: adminOrOwner,
                meetingLink: adminOrOwner,
                match: adminOrOwner,
