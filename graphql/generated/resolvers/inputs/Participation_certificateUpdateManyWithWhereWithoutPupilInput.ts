...
@TypeGraphQL.InputType("Participation_certificateUpdateManyWithWhereWithoutPupilInput", {
  isAbstract: true
})
export class Participation_certificateUpdateManyWithWhereWithoutPupilInput {
