...
const inputsInfo = {
  ...
  MatchOrderByWithRelationInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "studentId", "pupilId", "pupil", "student"],
  MatchWhereUniqueInput: ["id", "uuid", "UQ_MATCH"],
  MatchOrderByWithAggregationInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "studentId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  MatchCountOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "studentId", "pupilId"],
  MatchAvgOrderByAggregateInput: ["id", "dissolveReason", "studentId", "pupilId"],
  MatchMaxOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "studentId", "pupilId"],
  MatchMinOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "studentId", "pupilId"],
