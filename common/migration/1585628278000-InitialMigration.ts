...
export class InitialMigration1585628278000 implements MigrationInterface {
    name = 'InitialMigration1585628278000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "student" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "firstname" character varying, "lastname" character varying, "active" boolean NOT NULL DEFAULT 'TRUE', "email" character varying NOT NULL, "verification" character varying DEFAULT null, "verifiedAt" TIMESTAMP DEFAULT null, "authToken" character varying DEFAULT null, "wix_id" character varying NOT NULL, "wix_creation_date" TIMESTAMP NOT NULL, "birthday" date, "subjects" character varying NOT NULL, "msg" character varying, "phone" character varying, "feedback" character varying, "moreMatchRequests" integer NOT NULL DEFAULT 0, CONSTRAINT "PK_3d8016e1cb58429474a3c041904" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "pupil" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "firstname" character varying, "lastname" character varying, "active" boolean NOT NULL DEFAULT 'TRUE', "email" character varying NOT NULL, "verification" character varying DEFAULT null, "verifiedAt" TIMESTAMP DEFAULT null, "authToken" character varying DEFAULT null, "wix_id" character varying NOT NULL, "wix_creation_date" TIMESTAMP NOT NULL, "subjects" character varying NOT NULL, "state" character varying, "msg" character varying, "grade" character varying, CONSTRAINT "PK_34f2dbae733affb8884c2255c21" PRIMARY KEY ("id"))`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "match_source_enum"`, undefined);
