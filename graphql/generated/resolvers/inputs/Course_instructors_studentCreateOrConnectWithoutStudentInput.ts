...
@TypeGraphQL.InputType("Course_instructors_studentCreateOrConnectWithoutStudentInput", {
  isAbstract: true
})
export class Course_instructors_studentCreateOrConnectWithoutStudentInput {
