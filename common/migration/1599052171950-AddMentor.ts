...
export class AddMentor1599052171950 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_5c42dcf75b1abecf9860e54a12" ON "mentor" ("wix_id") `, undefined);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_5c42dcf75b1abecf9860e54a12"`, undefined);
