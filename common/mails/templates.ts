...
export const mailjet = {
    VERIFICATION: (variables: { confirmationURL: string; personFirstname: string }) => {
        return <TemplateMail>{
            type: 'verification',
            id: 1336516,
    ...
    LOGINTOKEN: (variables: { dashboardURL: string; personFirstname: string }) => {
        return <TemplateMail>{
            type: 'logintoken',
            id: 1337159,
            sender: DEFAULTSENDERS.support,
    ...
    STUDENTMATCHDISSOLVED: (variables: { pupilFirstname: string; studentFirstname: string }) => {
        return <TemplateMail>{
    ...
    STUDENTFIRSTSCREENINGINVITATION: (variables: { personFirstname: string; confirmationURL: string }) => {
        return <TemplateMail>{
    ...
    INSTRUCTORFIRSTSCREENINGINVITATION: (variables: { instructorFirstName: string; confirmationURL: string }) => {
        return <TemplateMail>{
    ...
    PROJECTCOACHJUFOALUMNISCREENINGREMINDER: (variables: { personFirstname: string; confirmationURL: string }) => {
        return <TemplateMail>{
    ...
    PROJECTCOACHEEMATCHDISSOLVED: (variables: { coacheeFirstname: string; coachFirstname: string }) => {
        return <TemplateMail>{
    ...
    PROJECTCOACHMATCHDISSOLVED: (variables: { coachFirstname: string; coacheeFirstname: string }) => {
        return <TemplateMail>{
    ...
    COACHEENEWMATCH: (variables: { coacheeFirstname: string; coachFirstname: string; coachEmail: string; subjects: string; callURL: string }) => {
        return <TemplateMail>{
    ...
    PUPILMATCHREQUESTCONFIRMATION: (variables: { firstName: string; authToken: string; confirmationURL: string; refusalURL: string }) => {
        return <TemplateMail>{
    ...
    PUPILMATCHREQUESTCONFIRMATIONREMINDER: (variables: { firstName: string; authToken: string; confirmationURL: string; refusalURL: string }) => {
        return <TemplateMail>{
