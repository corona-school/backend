...
@TypeGraphQL.InputType("Course_instructors_studentUpsertWithWhereUniqueWithoutStudentInput", {
  isAbstract: true
})
export class Course_instructors_studentUpsertWithWhereUniqueWithoutStudentInput {
  ...
  update!: Course_instructors_studentUpdateWithoutStudentInput;

  @TypeGraphQL.Field(_type => Course_instructors_studentCreateWithoutStudentInput, {
    nullable: false
  })
  create!: Course_instructors_studentCreateWithoutStudentInput;
}
