...
const inputsInfo = {
  ...
  StudentCreateWithoutExpert_dataInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "languages", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "screening", "subcourse_instructors_student"],
  ...
  StudentCreateWithoutInstructor_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "languages", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "screening", "subcourse_instructors_student"],
