...
export async function sendInstructorGroupMail(participant: Pupil, instructor: Student, course: Course, messageTitle: string, messageBody: string, data?: { contentType: string; filename: string; base64Content: string; }[]) {
