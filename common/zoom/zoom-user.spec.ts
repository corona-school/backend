...
import { deleteZoomUser, getZoomUser, createZoomUser, updateZoomUser } from './zoom-user';
...
test('Update a Zoom user', async () => {
    const result = await updateZoomUser(updatedUser);
