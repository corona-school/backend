...
@TypeGraphQL.InputType("Course_tags_course_tagUpdateManyWithWhereWithoutCourse_tagInput", {
  isAbstract: true
})
export class Course_tags_course_tagUpdateManyWithWhereWithoutCourse_tagInput {
