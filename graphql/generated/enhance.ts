...
const crudResolversMap = {
  ...
  Remission_request: crudResolvers.Remission_requestCrudResolver,
...
const actionResolversMap = {
  ...
  Remission_request: {
    remission_request: actionResolvers.FindUniqueRemission_requestResolver,
    findFirstRemission_request: actionResolvers.FindFirstRemission_requestResolver,
    remission_requests: actionResolvers.FindManyRemission_requestResolver,
    createRemission_request: actionResolvers.CreateRemission_requestResolver,
    createManyRemission_request: actionResolvers.CreateManyRemission_requestResolver,
    deleteRemission_request: actionResolvers.DeleteRemission_requestResolver,
    updateRemission_request: actionResolvers.UpdateRemission_requestResolver,
    deleteManyRemission_request: actionResolvers.DeleteManyRemission_requestResolver,
    updateManyRemission_request: actionResolvers.UpdateManyRemission_requestResolver,
    upsertRemission_request: actionResolvers.UpsertRemission_requestResolver,
    aggregateRemission_request: actionResolvers.AggregateRemission_requestResolver,
    groupByRemission_request: actionResolvers.GroupByRemission_requestResolver
  },
  School: {
...
const crudResolversInfo = {
  ...
  Remission_request: ["remission_request", "findFirstRemission_request", "remission_requests", "createRemission_request", "createManyRemission_request", "deleteRemission_request", "updateRemission_request", "deleteManyRemission_request", "updateManyRemission_request", "upsertRemission_request", "aggregateRemission_request", "groupByRemission_request"],
...
const argsInfo = {
  ...
  FindUniqueRemission_requestArgs: ["where"],
  FindFirstRemission_requestArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyRemission_requestArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateRemission_requestArgs: ["data"],
  CreateManyRemission_requestArgs: ["data", "skipDuplicates"],
  DeleteRemission_requestArgs: ["where"],
  UpdateRemission_requestArgs: ["data", "where"],
  DeleteManyRemission_requestArgs: ["where"],
  UpdateManyRemission_requestArgs: ["data", "where"],
  UpsertRemission_requestArgs: ["where", "create", "update"],
  AggregateRemission_requestArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByRemission_requestArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const relationResolversMap = {
  ...
  Remission_request: relationResolvers.Remission_requestRelationsResolver,
...
const relationResolversInfo = {
  ...
  Remission_request: ["student"],
  School: ["pupil"],
  Screener: ["instructor_screening", "project_coaching_screening", "screenings"],
  Screening: ["screener", "student"],
  Student: ["certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  Certificate_of_conduct: ["student"]
};
...
const modelsInfo = {
  ...
  Match: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  ...
  Remission_request: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
...
const outputsInfo = {
  ...
  MatchGroupBy: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  PupilGroupBy: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateRemission_request: ["_count", "_avg", "_sum", "_min", "_max"],
  Remission_requestGroupBy: ["id", "createdAt", "updatedAt", "uuid", "studentId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  CourseCount: ["course_guest", "course_instructors_student", "course_tags_course_tag", "subcourse"],
  ...
  Course_tagCount: ["course_tags_course_tag"],
  ...
  Expert_dataCount: ["expert_data_expertise_tags_expertise_tag"],
  ...
  Expertise_tagCount: ["expert_data_expertise_tags_expertise_tag"],
  ...
  LectureCount: ["course_attendance_log"],
  ...
  MatchCountAggregate: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId", "_all"],
  MatchAvgAggregate: ["id", "dissolveReason", "studentId", "pupilId"],
  MatchSumAggregate: ["id", "dissolveReason", "studentId", "pupilId"],
  MatchMinAggregate: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  MatchMaxAggregate: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  ...
  PupilCount: ["course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilCountAggregate: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId", "_all"],
  ...
  Remission_requestCountAggregate: ["id", "createdAt", "updatedAt", "uuid", "studentId", "_all"],
  Remission_requestAvgAggregate: ["id", "studentId"],
  Remission_requestSumAggregate: ["id", "studentId"],
  Remission_requestMinAggregate: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  Remission_requestMaxAggregate: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  SchoolCount: ["pupil"],
  ...
  ScreenerCount: ["instructor_screening", "project_coaching_screening", "screenings"],
  ...
  StudentCount: ["course", "course_guest", "course_instructors_student", "course_participation_certificate", "lecture", "match", "participation_certificate", "project_field_with_grade_restriction", "project_match", "subcourse_instructors_student"],
  ...
  SubcourseCount: ["course_participation_certificate", "lecture", "subcourse_instructors_student", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  ...
  Certificate_of_conductCountAggregate: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId", "_all"],
...
const inputsInfo = {
  ...
  Bbb_meetingOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "meetingID", "meetingName", "attendeePW", "moderatorPW", "alternativeUrl"],
  Bbb_meetingWhereUniqueInput: ["id"],
  Bbb_meetingOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "meetingID", "meetingName", "attendeePW", "moderatorPW", "alternativeUrl", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Concrete_notificationOrderByWithRelationInput: ["id", "userId", "notificationID", "contextID", "context", "sentAt", "state", "error"],
  Concrete_notificationWhereUniqueInput: ["id"],
  Concrete_notificationOrderByWithAggregationInput: ["id", "userId", "notificationID", "contextID", "context", "sentAt", "state", "error", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  CourseOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "outline", "description", "imageKey", "category", "courseState", "screeningComment", "publicRanking", "allowContact", "correspondentId", "student", "course_guest", "course_instructors_student", "course_tags_course_tag", "subcourse"],
  CourseWhereUniqueInput: ["id"],
  CourseOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "outline", "description", "imageKey", "category", "courseState", "screeningComment", "publicRanking", "allowContact", "correspondentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_attendance_logOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "attendedTime", "ip", "pupilId", "lectureId", "lecture", "pupil"],
  Course_attendance_logWhereUniqueInput: ["id"],
  Course_attendance_logOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "attendedTime", "ip", "pupilId", "lectureId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_guestOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "token", "firstname", "lastname", "email", "courseId", "inviterId", "course", "student"],
  Course_guestWhereUniqueInput: ["id", "token"],
  Course_guestOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "token", "firstname", "lastname", "email", "courseId", "inviterId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_instructors_studentOrderByWithRelationInput: ["courseId", "studentId", "course", "student"],
  Course_instructors_studentWhereUniqueInput: ["courseId_studentId"],
  Course_instructors_studentOrderByWithAggregationInput: ["courseId", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_participation_certificateOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "issuerId", "pupilId", "subcourseId", "student", "pupil", "subcourse"],
  Course_participation_certificateWhereUniqueInput: ["id"],
  Course_participation_certificateOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "issuerId", "pupilId", "subcourseId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_tagOrderByWithRelationInput: ["id", "identifier", "name", "category", "course_tags_course_tag"],
  Course_tagWhereUniqueInput: ["id", "identifier"],
  Course_tagOrderByWithAggregationInput: ["id", "identifier", "name", "category", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Course_tags_course_tagOrderByWithRelationInput: ["courseId", "courseTagId", "course", "course_tag"],
  Course_tags_course_tagWhereUniqueInput: ["courseId_courseTagId"],
  Course_tags_course_tagOrderByWithAggregationInput: ["courseId", "courseTagId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Expert_dataOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "contactEmail", "description", "active", "allowed", "studentId", "student", "expert_data_expertise_tags_expertise_tag"],
  Expert_dataWhereUniqueInput: ["id", "studentId"],
  Expert_dataOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "contactEmail", "description", "active", "allowed", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Expert_data_expertise_tags_expertise_tagOrderByWithRelationInput: ["expertDataId", "expertiseTagId", "expert_data", "expertise_tag"],
  Expert_data_expertise_tags_expertise_tagWhereUniqueInput: ["expertDataId_expertiseTagId"],
  Expert_data_expertise_tags_expertise_tagOrderByWithAggregationInput: ["expertDataId", "expertiseTagId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Expertise_tagOrderByWithRelationInput: ["id", "name", "expert_data_expertise_tags_expertise_tag"],
  Expertise_tagWhereUniqueInput: ["id", "name"],
  Expertise_tagOrderByWithAggregationInput: ["id", "name", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Instructor_screeningOrderByWithRelationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "screener", "student"],
  Instructor_screeningWhereUniqueInput: ["id", "studentId"],
  Instructor_screeningOrderByWithAggregationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Jufo_verification_transmissionOrderByWithRelationInput: ["id", "createdAt", "uuid", "studentId", "student"],
  Jufo_verification_transmissionWhereUniqueInput: ["id", "studentId"],
  Jufo_verification_transmissionOrderByWithAggregationInput: ["id", "createdAt", "uuid", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  LectureOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "start", "duration", "instructorId", "subcourseId", "student", "subcourse", "course_attendance_log"],
  LectureWhereUniqueInput: ["id"],
  LectureOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "start", "duration", "instructorId", "subcourseId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  LogOrderByWithRelationInput: ["id", "logtype", "createdAt", "user", "data"],
  LogWhereUniqueInput: ["id"],
  LogOrderByWithAggregationInput: ["id", "logtype", "createdAt", "user", "data", "_count", "_avg", "_max", "_min", "_sum"],
  LogScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "logtype", "createdAt", "user", "data"],
  MatchWhereInput: ["AND", "OR", "NOT", "id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId", "pupil", "student"],
  MatchOrderByWithRelationInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId", "pupil", "student"],
  MatchWhereUniqueInput: ["id", "uuid", "UQ_MATCH"],
  MatchOrderByWithAggregationInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  MatchScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  ...
  MentorOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "division", "expertise", "subjects", "teachingExperience", "message", "description", "imageUrl"],
  ...
  Participation_certificateOrderByWithAggregationInput: ["id", "uuid", "subjects", "categories", "certificateDate", "startDate", "endDate", "hoursPerWeek", "hoursTotal", "medium", "ongoingLessons", "state", "signaturePupil", "signatureParent", "signatureLocation", "signatureDate", "studentId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Project_coaching_screeningOrderByWithRelationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "screener", "student"],
  Project_coaching_screeningWhereUniqueInput: ["id", "studentId"],
  Project_coaching_screeningOrderByWithAggregationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Project_field_with_grade_restrictionOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "projectField", "min", "max", "studentId", "student"],
  Project_field_with_grade_restrictionWhereUniqueInput: ["id", "UQ_PROJECT_FIELDS"],
  Project_field_with_grade_restrictionOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "projectField", "min", "max", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Project_matchOrderByWithRelationInput: ["id", "uuid", "createdAt", "updatedAt", "dissolved", "dissolveReason", "studentId", "pupilId", "pupil", "student"],
  Project_matchWhereUniqueInput: ["id", "uuid", "UQ_PJ_MATCH"],
  Project_matchOrderByWithAggregationInput: ["id", "uuid", "createdAt", "updatedAt", "dissolved", "dissolveReason", "studentId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  PupilWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilWhereUniqueInput: ["id", "email", "verification", "authToken", "wix_id", "coduToken"],
  PupilOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Pupil_tutoring_interest_confirmation_requestOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "status", "token", "reminderSentDate", "pupilId", "pupil"],
  Pupil_tutoring_interest_confirmation_requestWhereUniqueInput: ["id", "token", "pupilId"],
  Pupil_tutoring_interest_confirmation_requestOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "status", "token", "reminderSentDate", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Remission_requestWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "uuid", "studentId", "student"],
  Remission_requestOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "uuid", "studentId", "student"],
  Remission_requestWhereUniqueInput: ["id", "uuid", "studentId"],
  Remission_requestOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "uuid", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  Remission_requestScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "uuid", "studentId"],
  SchoolWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation", "pupil"],
  SchoolOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation", "pupil"],
  SchoolWhereUniqueInput: ["id", "website", "emailDomain"],
  SchoolOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  ScreenerWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening", "screenings"],
  ScreenerOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening", "screenings"],
  ScreenerWhereUniqueInput: ["id", "email", "verification", "authToken", "oldNumberID"],
  ScreenerOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  ScreeningOrderByWithRelationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "screener", "student"],
  ScreeningWhereUniqueInput: ["id", "studentId"],
  ScreeningOrderByWithAggregationInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  StudentWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  StudentOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  StudentWhereUniqueInput: ["id", "email", "verification", "authToken", "wix_id"],
  StudentOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  SubcourseOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "minGrade", "maxGrade", "maxParticipants", "joinAfterStart", "published", "cancelled", "courseId", "course", "course_participation_certificate", "lecture", "subcourse_instructors_student", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  SubcourseWhereUniqueInput: ["id"],
  SubcourseOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "minGrade", "maxGrade", "maxParticipants", "joinAfterStart", "published", "cancelled", "courseId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Subcourse_instructors_studentOrderByWithRelationInput: ["subcourseId", "studentId", "student", "subcourse"],
  Subcourse_instructors_studentWhereUniqueInput: ["subcourseId_studentId"],
  Subcourse_instructors_studentOrderByWithAggregationInput: ["subcourseId", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Subcourse_participants_pupilOrderByWithRelationInput: ["subcourseId", "pupilId", "pupil", "subcourse"],
  Subcourse_participants_pupilWhereUniqueInput: ["subcourseId_pupilId"],
  Subcourse_participants_pupilOrderByWithAggregationInput: ["subcourseId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Subcourse_waiting_list_pupilOrderByWithRelationInput: ["subcourseId", "pupilId", "pupil", "subcourse"],
  Subcourse_waiting_list_pupilWhereUniqueInput: ["subcourseId_pupilId"],
  Subcourse_waiting_list_pupilOrderByWithAggregationInput: ["subcourseId", "pupilId", "_count", "_avg", "_max", "_min", "_sum"],
  Subcourse_waiting_list_pupilScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "subcourseId", "pupilId"],
  Certificate_of_conductWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId", "student"],
  Certificate_of_conductOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId", "student"],
  Certificate_of_conductWhereUniqueInput: ["id", "studentId"],
  Certificate_of_conductOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  Match_pool_runOrderByWithRelationInput: ["id", "runAt", "matchingPool", "matchesCreated", "stats"],
  ...
  MatchCreateInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "pupil", "student"],
  MatchUpdateInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "pupil", "student"],
  MatchCreateManyInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  MatchUpdateManyMutationInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool"],
  MentorCreateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "division", "expertise", "subjects", "teachingExperience", "message", "description", "imageUrl"],
  ...
  PupilCreateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilUpdateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilCreateManyInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId"],
  PupilUpdateManyMutationInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken"],
  ...
  Remission_requestCreateInput: ["createdAt", "updatedAt", "uuid", "student"],
  Remission_requestUpdateInput: ["createdAt", "updatedAt", "uuid", "student"],
  Remission_requestCreateManyInput: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  Remission_requestUpdateManyMutationInput: ["createdAt", "updatedAt", "uuid"],
  ...
  ScreenerCreateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening", "screenings"],
  ScreenerUpdateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening", "screenings"],
  ...
  Certificate_of_conductCreateInput: ["createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "student"],
  ...
  Bbb_meetingCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "meetingID", "meetingName", "attendeePW", "moderatorPW", "alternativeUrl"],
  Bbb_meetingAvgOrderByAggregateInput: ["id"],
  Bbb_meetingMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "meetingID", "meetingName", "attendeePW", "moderatorPW", "alternativeUrl"],
  Bbb_meetingMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "meetingID", "meetingName", "attendeePW", "moderatorPW", "alternativeUrl"],
  Bbb_meetingSumOrderByAggregateInput: ["id"],
  IntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  DateTimeWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_min", "_max"],
  StringWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not", "_count", "_min", "_max"],
  StringNullableWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not", "_count", "_min", "_max"],
  JsonFilter: ["equals", "not"],
  Concrete_notificationCountOrderByAggregateInput: ["id", "userId", "notificationID", "contextID", "context", "sentAt", "state", "error"],
  Concrete_notificationAvgOrderByAggregateInput: ["id", "notificationID", "state"],
  Concrete_notificationMaxOrderByAggregateInput: ["id", "userId", "notificationID", "contextID", "sentAt", "state", "error"],
  Concrete_notificationMinOrderByAggregateInput: ["id", "userId", "notificationID", "contextID", "sentAt", "state", "error"],
  Concrete_notificationSumOrderByAggregateInput: ["id", "notificationID", "state"],
  ...
  Course_guestOrderByRelationAggregateInput: ["_count"],
  Course_instructors_studentOrderByRelationAggregateInput: ["_count"],
  Course_tags_course_tagOrderByRelationAggregateInput: ["_count"],
  SubcourseOrderByRelationAggregateInput: ["_count"],
  CourseCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "outline", "description", "imageKey", "category", "courseState", "screeningComment", "publicRanking", "allowContact", "correspondentId"],
  CourseAvgOrderByAggregateInput: ["id", "publicRanking", "correspondentId"],
  CourseMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "outline", "description", "imageKey", "category", "courseState", "screeningComment", "publicRanking", "allowContact", "correspondentId"],
  CourseMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "outline", "description", "imageKey", "category", "courseState", "screeningComment", "publicRanking", "allowContact", "correspondentId"],
  CourseSumOrderByAggregateInput: ["id", "publicRanking", "correspondentId"],
  ...
  Course_attendance_logCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "attendedTime", "ip", "pupilId", "lectureId"],
  Course_attendance_logAvgOrderByAggregateInput: ["id", "attendedTime", "pupilId", "lectureId"],
  Course_attendance_logMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "attendedTime", "ip", "pupilId", "lectureId"],
  Course_attendance_logMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "attendedTime", "ip", "pupilId", "lectureId"],
  Course_attendance_logSumOrderByAggregateInput: ["id", "attendedTime", "pupilId", "lectureId"],
  CourseRelationFilter: ["is", "isNot"],
  Course_guestCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "token", "firstname", "lastname", "email", "courseId", "inviterId"],
  Course_guestAvgOrderByAggregateInput: ["id", "courseId", "inviterId"],
  Course_guestMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "token", "firstname", "lastname", "email", "courseId", "inviterId"],
  Course_guestMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "token", "firstname", "lastname", "email", "courseId", "inviterId"],
  Course_guestSumOrderByAggregateInput: ["id", "courseId", "inviterId"],
  course_instructors_studentCourseIdStudentIdCompoundUniqueInput: ["courseId", "studentId"],
  Course_instructors_studentCountOrderByAggregateInput: ["courseId", "studentId"],
  Course_instructors_studentAvgOrderByAggregateInput: ["courseId", "studentId"],
  Course_instructors_studentMaxOrderByAggregateInput: ["courseId", "studentId"],
  Course_instructors_studentMinOrderByAggregateInput: ["courseId", "studentId"],
  Course_instructors_studentSumOrderByAggregateInput: ["courseId", "studentId"],
  SubcourseRelationFilter: ["is", "isNot"],
  Course_participation_certificateCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "issuerId", "pupilId", "subcourseId"],
  Course_participation_certificateAvgOrderByAggregateInput: ["id", "issuerId", "pupilId", "subcourseId"],
  Course_participation_certificateMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "issuerId", "pupilId", "subcourseId"],
  Course_participation_certificateMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "issuerId", "pupilId", "subcourseId"],
  Course_participation_certificateSumOrderByAggregateInput: ["id", "issuerId", "pupilId", "subcourseId"],
  Course_tagCountOrderByAggregateInput: ["id", "identifier", "name", "category"],
  Course_tagAvgOrderByAggregateInput: ["id"],
  Course_tagMaxOrderByAggregateInput: ["id", "identifier", "name", "category"],
  Course_tagMinOrderByAggregateInput: ["id", "identifier", "name", "category"],
  Course_tagSumOrderByAggregateInput: ["id"],
  Course_tagRelationFilter: ["is", "isNot"],
  course_tags_course_tagCourseIdCourseTagIdCompoundUniqueInput: ["courseId", "courseTagId"],
  Course_tags_course_tagCountOrderByAggregateInput: ["courseId", "courseTagId"],
  Course_tags_course_tagAvgOrderByAggregateInput: ["courseId", "courseTagId"],
  Course_tags_course_tagMaxOrderByAggregateInput: ["courseId", "courseTagId"],
  Course_tags_course_tagMinOrderByAggregateInput: ["courseId", "courseTagId"],
  Course_tags_course_tagSumOrderByAggregateInput: ["courseId", "courseTagId"],
  ...
  Expert_data_expertise_tags_expertise_tagOrderByRelationAggregateInput: ["_count"],
  Expert_dataCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "contactEmail", "description", "active", "allowed", "studentId"],
  Expert_dataAvgOrderByAggregateInput: ["id", "studentId"],
  Expert_dataMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "contactEmail", "description", "active", "allowed", "studentId"],
  Expert_dataMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "contactEmail", "description", "active", "allowed", "studentId"],
  Expert_dataSumOrderByAggregateInput: ["id", "studentId"],
  ...
  Expert_data_expertise_tags_expertise_tagCountOrderByAggregateInput: ["expertDataId", "expertiseTagId"],
  Expert_data_expertise_tags_expertise_tagAvgOrderByAggregateInput: ["expertDataId", "expertiseTagId"],
  Expert_data_expertise_tags_expertise_tagMaxOrderByAggregateInput: ["expertDataId", "expertiseTagId"],
  Expert_data_expertise_tags_expertise_tagMinOrderByAggregateInput: ["expertDataId", "expertiseTagId"],
  Expert_data_expertise_tags_expertise_tagSumOrderByAggregateInput: ["expertDataId", "expertiseTagId"],
  Expertise_tagCountOrderByAggregateInput: ["id", "name"],
  Expertise_tagAvgOrderByAggregateInput: ["id"],
  Expertise_tagMaxOrderByAggregateInput: ["id", "name"],
  Expertise_tagMinOrderByAggregateInput: ["id", "name"],
  Expertise_tagSumOrderByAggregateInput: ["id"],
  ScreenerRelationFilter: ["is", "isNot"],
  Instructor_screeningCountOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Instructor_screeningAvgOrderByAggregateInput: ["id", "screenerId", "studentId"],
  Instructor_screeningMaxOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Instructor_screeningMinOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Instructor_screeningSumOrderByAggregateInput: ["id", "screenerId", "studentId"],
  Jufo_verification_transmissionCountOrderByAggregateInput: ["id", "createdAt", "uuid", "studentId"],
  Jufo_verification_transmissionAvgOrderByAggregateInput: ["id", "studentId"],
  Jufo_verification_transmissionMaxOrderByAggregateInput: ["id", "createdAt", "uuid", "studentId"],
  Jufo_verification_transmissionMinOrderByAggregateInput: ["id", "createdAt", "uuid", "studentId"],
  Jufo_verification_transmissionSumOrderByAggregateInput: ["id", "studentId"],
  Course_attendance_logListRelationFilter: ["every", "some", "none"],
  Course_attendance_logOrderByRelationAggregateInput: ["_count"],
  LectureCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "start", "duration", "instructorId", "subcourseId"],
  LectureAvgOrderByAggregateInput: ["id", "duration", "instructorId", "subcourseId"],
  LectureMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "start", "duration", "instructorId", "subcourseId"],
  LectureMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "start", "duration", "instructorId", "subcourseId"],
  LectureSumOrderByAggregateInput: ["id", "duration", "instructorId", "subcourseId"],
  Enumlog_logtype_enumFilter: ["equals", "in", "notIn", "not"],
  LogCountOrderByAggregateInput: ["id", "logtype", "createdAt", "user", "data"],
  LogAvgOrderByAggregateInput: ["id"],
  LogMaxOrderByAggregateInput: ["id", "logtype", "createdAt", "user", "data"],
  LogMinOrderByAggregateInput: ["id", "logtype", "createdAt", "user", "data"],
  LogSumOrderByAggregateInput: ["id"],
  ...
  MatchCountOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  MatchAvgOrderByAggregateInput: ["id", "dissolveReason", "studentId", "pupilId"],
  MatchMaxOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  MatchMinOrderByAggregateInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  MatchSumOrderByAggregateInput: ["id", "dissolveReason", "studentId", "pupilId"],
  ...
  MentorCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "division", "expertise", "subjects", "teachingExperience", "message", "description", "imageUrl"],
  MentorAvgOrderByAggregateInput: ["id"],
  MentorMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "subjects", "teachingExperience", "message", "description", "imageUrl"],
  MentorMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "subjects", "teachingExperience", "message", "description", "imageUrl"],
  ...
  Participation_certificateAvgOrderByAggregateInput: ["id", "hoursPerWeek", "hoursTotal", "studentId", "pupilId"],
  Participation_certificateMaxOrderByAggregateInput: ["id", "uuid", "subjects", "categories", "certificateDate", "startDate", "endDate", "hoursPerWeek", "hoursTotal", "medium", "ongoingLessons", "state", "signaturePupil", "signatureParent", "signatureLocation", "signatureDate", "studentId", "pupilId"],
  Participation_certificateMinOrderByAggregateInput: ["id", "uuid", "subjects", "categories", "certificateDate", "startDate", "endDate", "hoursPerWeek", "hoursTotal", "medium", "ongoingLessons", "state", "signaturePupil", "signatureParent", "signatureLocation", "signatureDate", "studentId", "pupilId"],
  Participation_certificateSumOrderByAggregateInput: ["id", "hoursPerWeek", "hoursTotal", "studentId", "pupilId"],
  ...
  Project_coaching_screeningCountOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Project_coaching_screeningAvgOrderByAggregateInput: ["id", "screenerId", "studentId"],
  Project_coaching_screeningMaxOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Project_coaching_screeningMinOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  Project_coaching_screeningSumOrderByAggregateInput: ["id", "screenerId", "studentId"],
  ...
  Project_field_with_grade_restrictionCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "projectField", "min", "max", "studentId"],
  Project_field_with_grade_restrictionAvgOrderByAggregateInput: ["id", "min", "max", "studentId"],
  Project_field_with_grade_restrictionMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "projectField", "min", "max", "studentId"],
  Project_field_with_grade_restrictionMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "projectField", "min", "max", "studentId"],
  Project_field_with_grade_restrictionSumOrderByAggregateInput: ["id", "min", "max", "studentId"],
  ...
  Project_matchCountOrderByAggregateInput: ["id", "uuid", "createdAt", "updatedAt", "dissolved", "dissolveReason", "studentId", "pupilId"],
  Project_matchAvgOrderByAggregateInput: ["id", "dissolveReason", "studentId", "pupilId"],
  Project_matchMaxOrderByAggregateInput: ["id", "uuid", "createdAt", "updatedAt", "dissolved", "dissolveReason", "studentId", "pupilId"],
  Project_matchMinOrderByAggregateInput: ["id", "uuid", "createdAt", "updatedAt", "dissolved", "dissolveReason", "studentId", "pupilId"],
  Project_matchSumOrderByAggregateInput: ["id", "dissolveReason", "studentId", "pupilId"],
  ...
  Course_participation_certificateOrderByRelationAggregateInput: ["_count"],
  MatchOrderByRelationAggregateInput: ["_count"],
  Participation_certificateOrderByRelationAggregateInput: ["_count"],
  Project_matchOrderByRelationAggregateInput: ["_count"],
  Subcourse_participants_pupilOrderByRelationAggregateInput: ["_count"],
  Subcourse_waiting_list_pupilOrderByRelationAggregateInput: ["_count"],
  PupilCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId"],
  PupilAvgOrderByAggregateInput: ["id", "openMatchRequestCount", "openProjectMatchRequestCount", "projectMemberCount", "matchingPriority", "schoolId"],
  PupilMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId"],
  PupilMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "schoolId"],
  PupilSumOrderByAggregateInput: ["id", "openMatchRequestCount", "openProjectMatchRequestCount", "projectMemberCount", "matchingPriority", "schoolId"],
  ...
  Pupil_tutoring_interest_confirmation_requestCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "status", "token", "reminderSentDate", "pupilId"],
  Pupil_tutoring_interest_confirmation_requestAvgOrderByAggregateInput: ["id", "pupilId"],
  Pupil_tutoring_interest_confirmation_requestMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "status", "token", "reminderSentDate", "pupilId"],
  Pupil_tutoring_interest_confirmation_requestMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "status", "token", "reminderSentDate", "pupilId"],
  Pupil_tutoring_interest_confirmation_requestSumOrderByAggregateInput: ["id", "pupilId"],
  Remission_requestCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  Remission_requestAvgOrderByAggregateInput: ["id", "studentId"],
  Remission_requestMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  Remission_requestMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "uuid", "studentId"],
  Remission_requestSumOrderByAggregateInput: ["id", "studentId"],
  ...
  PupilOrderByRelationAggregateInput: ["_count"],
  SchoolCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation"],
  SchoolAvgOrderByAggregateInput: ["id"],
  SchoolMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation"],
  SchoolMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "website", "emailDomain", "state", "schooltype", "activeCooperation"],
  SchoolSumOrderByAggregateInput: ["id"],
  ...
  Instructor_screeningOrderByRelationAggregateInput: ["_count"],
  Project_coaching_screeningOrderByRelationAggregateInput: ["_count"],
  ScreeningOrderByRelationAggregateInput: ["_count"],
  ScreenerCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID"],
  ScreenerAvgOrderByAggregateInput: ["id", "oldNumberID"],
  ScreenerMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID"],
  ScreenerMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID"],
  ScreenerSumOrderByAggregateInput: ["id", "oldNumberID"],
  ScreeningCountOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  ScreeningAvgOrderByAggregateInput: ["id", "screenerId", "studentId"],
  ScreeningMaxOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  ScreeningMinOrderByAggregateInput: ["id", "success", "comment", "knowsCoronaSchoolFrom", "createdAt", "updatedAt", "screenerId", "studentId"],
  ScreeningSumOrderByAggregateInput: ["id", "screenerId", "studentId"],
  ...
  Certificate_of_conductRelationFilter: ["is", "isNot"],
  ...
  Remission_requestRelationFilter: ["is", "isNot"],
  ...
  LectureOrderByRelationAggregateInput: ["_count"],
  Project_field_with_grade_restrictionOrderByRelationAggregateInput: ["_count"],
  Subcourse_instructors_studentOrderByRelationAggregateInput: ["_count"],
  StudentCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource"],
  StudentAvgOrderByAggregateInput: ["id", "openMatchRequestCount", "moduleHours", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "sentScreeningReminderCount", "sentInstructorScreeningReminderCount"],
  StudentMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource"],
  StudentMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource"],
  StudentSumOrderByAggregateInput: ["id", "openMatchRequestCount", "moduleHours", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "sentScreeningReminderCount", "sentInstructorScreeningReminderCount"],
  ...
  SubcourseCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "minGrade", "maxGrade", "maxParticipants", "joinAfterStart", "published", "cancelled", "courseId"],
  SubcourseAvgOrderByAggregateInput: ["id", "minGrade", "maxGrade", "maxParticipants", "courseId"],
  SubcourseMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "minGrade", "maxGrade", "maxParticipants", "joinAfterStart", "published", "cancelled", "courseId"],
  SubcourseMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "minGrade", "maxGrade", "maxParticipants", "joinAfterStart", "published", "cancelled", "courseId"],
  SubcourseSumOrderByAggregateInput: ["id", "minGrade", "maxGrade", "maxParticipants", "courseId"],
  subcourse_instructors_studentSubcourseIdStudentIdCompoundUniqueInput: ["subcourseId", "studentId"],
  Subcourse_instructors_studentCountOrderByAggregateInput: ["subcourseId", "studentId"],
  Subcourse_instructors_studentAvgOrderByAggregateInput: ["subcourseId", "studentId"],
  Subcourse_instructors_studentMaxOrderByAggregateInput: ["subcourseId", "studentId"],
  Subcourse_instructors_studentMinOrderByAggregateInput: ["subcourseId", "studentId"],
  Subcourse_instructors_studentSumOrderByAggregateInput: ["subcourseId", "studentId"],
  subcourse_participants_pupilSubcourseIdPupilIdCompoundUniqueInput: ["subcourseId", "pupilId"],
  Subcourse_participants_pupilCountOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_participants_pupilAvgOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_participants_pupilMaxOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_participants_pupilMinOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_participants_pupilSumOrderByAggregateInput: ["subcourseId", "pupilId"],
  subcourse_waiting_list_pupilSubcourseIdPupilIdCompoundUniqueInput: ["subcourseId", "pupilId"],
  Subcourse_waiting_list_pupilCountOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_waiting_list_pupilAvgOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_waiting_list_pupilMaxOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_waiting_list_pupilMinOrderByAggregateInput: ["subcourseId", "pupilId"],
  Subcourse_waiting_list_pupilSumOrderByAggregateInput: ["subcourseId", "pupilId"],
  Certificate_of_conductCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId"],
  Certificate_of_conductAvgOrderByAggregateInput: ["id", "studentId"],
  Certificate_of_conductMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId"],
  Certificate_of_conductMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords", "studentId"],
  Certificate_of_conductSumOrderByAggregateInput: ["id", "studentId"],
  Match_pool_runCountOrderByAggregateInput: ["id", "runAt", "matchingPool", "matchesCreated", "stats"],
  Match_pool_runAvgOrderByAggregateInput: ["id", "matchesCreated"],
  ...
  StudentUpdateOneWithoutCourseInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Course_guestUpdateManyWithoutCourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_instructors_studentUpdateManyWithoutCourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_tags_course_tagUpdateManyWithoutCourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  SubcourseUpdateManyWithoutCourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  LectureUpdateOneWithoutCourse_attendance_logInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  PupilUpdateOneWithoutCourse_attendance_logInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  CourseUpdateOneWithoutCourse_guestInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutCourse_guestInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  StudentUpdateOneWithoutCourse_participation_certificateInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  PupilUpdateOneWithoutCourse_participation_certificateInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  SubcourseUpdateOneWithoutCourse_participation_certificateInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Course_tags_course_tagCreateNestedManyWithoutCourse_tagInput: ["create", "connectOrCreate", "createMany", "connect"],
  Course_tags_course_tagUpdateManyWithoutCourse_tagInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  StudentUpdateOneWithoutExpert_dataInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Expert_data_expertise_tags_expertise_tagUpdateManyWithoutExpert_dataInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  Expert_data_expertise_tags_expertise_tagUpdateManyWithoutExpertise_tagInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ScreenerUpdateOneWithoutInstructor_screeningInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutInstructor_screeningInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentCreateNestedOneWithoutJufo_verification_transmissionInput: ["create", "connectOrCreate", "connect"],
  StudentUpdateOneWithoutJufo_verification_transmissionInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  StudentUpdateOneWithoutLectureInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  SubcourseUpdateOneWithoutLectureInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Course_attendance_logUpdateManyWithoutLectureInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  PupilUpdateOneWithoutMatchInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutMatchInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  PupilUpdateOneWithoutParticipation_certificateInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutParticipation_certificateInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  ScreenerUpdateOneWithoutProject_coaching_screeningInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutProject_coaching_screeningInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  PupilUpdateOneWithoutProject_matchInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutProject_matchInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  SchoolUpdateOneWithoutPupilInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Course_attendance_logUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_participation_certificateUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  MatchUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Participation_certificateUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Project_matchUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Pupil_tutoring_interest_confirmation_requestUpdateOneWithoutPupilInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Subcourse_participants_pupilUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Subcourse_waiting_list_pupilUpdateManyWithoutPupilInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  PupilCreateNestedOneWithoutPupil_tutoring_interest_confirmation_requestInput: ["create", "connectOrCreate", "connect"],
  PupilUpdateOneWithoutPupil_tutoring_interest_confirmation_requestInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentCreateNestedOneWithoutRemission_requestInput: ["create", "connectOrCreate", "connect"],
  StudentUpdateOneWithoutRemission_requestInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  PupilUpdateManyWithoutSchoolInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  Instructor_screeningUpdateManyWithoutScreenerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Project_coaching_screeningUpdateManyWithoutScreenerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ScreeningUpdateManyWithoutScreenerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ScreenerCreateNestedOneWithoutScreeningsInput: ["create", "connectOrCreate", "connect"],
  StudentCreateNestedOneWithoutScreeningInput: ["create", "connectOrCreate", "connect"],
  ScreenerUpdateOneWithoutScreeningsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentUpdateOneWithoutScreeningInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  StudentCreatelanguagesInput: ["set"],
  Certificate_of_conductCreateNestedOneWithoutStudentInput: ["create", "connectOrCreate", "connect"],
  ...
  Remission_requestCreateNestedOneWithoutStudentInput: ["create", "connectOrCreate", "connect"],
  ...
  Certificate_of_conductUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  CourseUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_guestUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_instructors_studentUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Course_participation_certificateUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Expert_dataUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Instructor_screeningUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Jufo_verification_transmissionUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  LectureUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  MatchUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Participation_certificateUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Project_coaching_screeningUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Project_field_with_grade_restrictionUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Project_matchUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Remission_requestUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ScreeningUpdateOneWithoutStudentInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Subcourse_instructors_studentUpdateManyWithoutStudentInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  CourseUpdateOneWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  Course_participation_certificateUpdateManyWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  LectureUpdateManyWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Subcourse_instructors_studentUpdateManyWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Subcourse_participants_pupilUpdateManyWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  Subcourse_waiting_list_pupilUpdateManyWithoutSubcourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  StudentUpdateOneWithoutCertificate_of_conductInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  StudentCreateWithoutCourseInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  PupilCreateWithoutCourse_attendance_logInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  ...
  StudentCreateWithoutCourse_guestInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  StudentCreateWithoutCourse_instructors_studentInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  StudentCreateWithoutCourse_participation_certificateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  StudentCreateOrConnectWithoutCourse_participation_certificateInput: ["where", "create"],
  PupilCreateWithoutCourse_participation_certificateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  ...
  StudentCreateWithoutExpert_dataInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  ScreenerCreateWithoutInstructor_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "project_coaching_screening", "screenings"],
  ScreenerCreateOrConnectWithoutInstructor_screeningInput: ["where", "create"],
  StudentCreateWithoutInstructor_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  ScreenerUpdateWithoutInstructor_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "project_coaching_screening", "screenings"],
  StudentUpsertWithoutInstructor_screeningInput: ["update", "create"],
  StudentUpdateWithoutInstructor_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  StudentCreateWithoutJufo_verification_transmissionInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  StudentCreateWithoutLectureInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  PupilCreateWithoutMatchInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilCreateOrConnectWithoutMatchInput: ["where", "create"],
  StudentCreateWithoutMatchInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  PupilCreateWithoutParticipation_certificateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "match", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilCreateOrConnectWithoutParticipation_certificateInput: ["where", "create"],
  StudentCreateWithoutParticipation_certificateInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  ScreenerCreateWithoutProject_coaching_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "screenings"],
  ScreenerCreateOrConnectWithoutProject_coaching_screeningInput: ["where", "create"],
  StudentCreateWithoutProject_coaching_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  ScreenerUpdateWithoutProject_coaching_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "screenings"],
  StudentUpsertWithoutProject_coaching_screeningInput: ["update", "create"],
  StudentUpdateWithoutProject_coaching_screeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_field_with_grade_restriction", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  StudentCreateWithoutProject_field_with_grade_restrictionInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_match", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  PupilCreateWithoutProject_matchInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  PupilCreateOrConnectWithoutProject_matchInput: ["where", "create"],
  StudentCreateWithoutProject_matchInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "remission_request", "screening", "subcourse_instructors_student"],
  ...
  MatchCreateWithoutPupilInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "student"],
  ...
  MatchScalarWhereInput: ["AND", "OR", "NOT", "id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId", "pupilId"],
  ...
  PupilCreateWithoutPupil_tutoring_interest_confirmation_requestInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "school", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  ...
  StudentCreateWithoutRemission_requestInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "screening", "subcourse_instructors_student"],
  StudentCreateOrConnectWithoutRemission_requestInput: ["where", "create"],
  StudentUpsertWithoutRemission_requestInput: ["update", "create"],
  StudentUpdateWithoutRemission_requestInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "screening", "subcourse_instructors_student"],
  PupilCreateWithoutSchoolInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "state", "schooltype", "msg", "grade", "newsletter", "isPupil", "subjects", "openMatchRequestCount", "isParticipant", "isProjectCoachee", "projectFields", "isJufoParticipant", "openProjectMatchRequestCount", "projectMemberCount", "languages", "learningGermanSince", "matchingPriority", "lastUpdatedSettingsViaBlocker", "teacherEmailAddress", "registrationSource", "coduToken", "course_attendance_log", "course_participation_certificate", "match", "participation_certificate", "project_match", "pupil_tutoring_interest_confirmation_request", "subcourse_participants_pupil", "subcourse_waiting_list_pupil"],
  ...
  ScreenerCreateWithoutScreeningsInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening"],
  ScreenerCreateOrConnectWithoutScreeningsInput: ["where", "create"],
  StudentCreateWithoutScreeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "subcourse_instructors_student"],
  StudentCreateOrConnectWithoutScreeningInput: ["where", "create"],
  ScreenerUpsertWithoutScreeningsInput: ["update", "create"],
  ScreenerUpdateWithoutScreeningsInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "password", "verified", "oldNumberID", "instructor_screening", "project_coaching_screening"],
  StudentUpsertWithoutScreeningInput: ["update", "create"],
  StudentUpdateWithoutScreeningInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "subcourse_instructors_student"],
  Certificate_of_conductCreateWithoutStudentInput: ["createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords"],
  ...
  MatchCreateWithoutStudentInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "pupil"],
  ...
  Remission_requestCreateWithoutStudentInput: ["createdAt", "updatedAt", "uuid"],
  Remission_requestCreateOrConnectWithoutStudentInput: ["where", "create"],
  ...
  Certificate_of_conductUpsertWithoutStudentInput: ["update", "create"],
  Certificate_of_conductUpdateWithoutStudentInput: ["createdAt", "updatedAt", "dateOfInspection", "dateOfIssue", "criminalRecords"],
  ...
  Remission_requestUpsertWithoutStudentInput: ["update", "create"],
  Remission_requestUpdateWithoutStudentInput: ["createdAt", "updatedAt", "uuid"],
  ...
  StudentCreateWithoutSubcourse_instructors_studentInput: ["createdAt", "updatedAt", "firstname", "lastname", "active", "email", "verification", "verifiedAt", "authToken", "authTokenUsed", "authTokenSent", "wix_id", "wix_creation_date", "phone", "feedback", "newsletter", "isStudent", "subjects", "openMatchRequestCount", "isCodu", "isInstructor", "msg", "state", "university", "module", "moduleHours", "isProjectCoach", "wasJufoParticipant", "hasJufoCertificate", "jufoPastParticipationInfo", "jufoPastParticipationConfirmed", "isUniversityStudent", "openProjectMatchRequestCount", "sentJufoAlumniScreeningReminderCount", "lastSentJufoAlumniScreeningInvitationDate", "supportsInDaZ", "languages", "sentScreeningReminderCount", "lastSentScreeningInvitationDate", "sentInstructorScreeningReminderCount", "lastSentInstructorScreeningInvitationDate", "lastUpdatedSettingsViaBlocker", "registrationSource", "certificate_of_conduct", "course", "course_guest", "course_instructors_student", "course_participation_certificate", "expert_data", "instructor_screening", "jufo_verification_transmission", "lecture", "match", "participation_certificate", "project_coaching_screening", "project_field_with_grade_restriction", "project_match", "remission_request", "screening"],
  ...
  MatchCreateManyPupilInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "studentId"],
  ...
  MatchUpdateWithoutPupilInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "student"],
  ...
  MatchCreateManyStudentInput: ["id", "uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "pupilId"],
  ...
  MatchUpdateWithoutStudentInput: ["uuid", "dissolved", "dissolveReason", "proposedTime", "createdAt", "updatedAt", "feedbackToPupilMail", "feedbackToStudentMail", "followUpToPupilMail", "followUpToStudentMail", "source", "matchPool", "pupil"],
