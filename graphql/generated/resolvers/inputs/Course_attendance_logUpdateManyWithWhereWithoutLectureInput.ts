...
@TypeGraphQL.InputType("Course_attendance_logUpdateManyWithWhereWithoutLectureInput", {
  isAbstract: true
})
export class Course_attendance_logUpdateManyWithWhereWithoutLectureInput {
