...
export class NotificationTemplates1672418676212 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "message_translation" ("id" SERIAL NOT NULL, "template" json NOT NULL, "language" "public"."message_translation_language_enum" NOT NULL DEFAULT 'de', "notificationId" integer, CONSTRAINT "PK_159f92cfb8a0b269fbc863c74ee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "notification" DROP COLUMN "type"`);
        await queryRunner.query(`CREATE TYPE "public"."notification_type_enum" AS ENUM('chat', 'survey', 'appointment', 'advice', 'suggestion', 'announcement', 'call', 'news', 'event', 'request', 'alternative', 'account', 'onboarding', 'match', 'course', 'certificate', 'legacy')`);
        await queryRunner.query(`ALTER TABLE "notification" ADD "type" "public"."notification_type_enum" NOT NULL DEFAULT 'legacy'`);
        await queryRunner.query(`ALTER TABLE "message_translation" ADD CONSTRAINT "FK_5ae486c5ef53f5335af8a4ae260" FOREIGN KEY ("notificationId") REFERENCES "notification"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
