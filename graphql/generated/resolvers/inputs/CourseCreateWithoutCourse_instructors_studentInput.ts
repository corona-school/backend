...
@TypeGraphQL.InputType("CourseCreateWithoutCourse_instructors_studentInput", {
  isAbstract: true
})
export class CourseCreateWithoutCourse_instructors_studentInput {
  ...
  @TypeGraphQL.Field(_type => StudentCreateNestedOneWithoutCourseInput, {
    nullable: true
  })
