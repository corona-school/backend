...
@TypeGraphQL.InputType("Project_field_with_grade_restrictionCreateWithoutStudentInput", {
  isAbstract: true
})
export class Project_field_with_grade_restrictionCreateWithoutStudentInput {
