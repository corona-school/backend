...
@TypeGraphQL.InputType("Subcourse_participants_pupilUpdateManyWithWhereWithoutSubcourseInput", {
  isAbstract: true
})
export class Subcourse_participants_pupilUpdateManyWithWhereWithoutSubcourseInput {
