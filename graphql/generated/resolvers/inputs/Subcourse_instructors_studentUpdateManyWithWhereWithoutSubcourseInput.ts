...
@TypeGraphQL.InputType("Subcourse_instructors_studentUpdateManyWithWhereWithoutSubcourseInput", {
  isAbstract: true
})
export class Subcourse_instructors_studentUpdateManyWithWhereWithoutSubcourseInput {
