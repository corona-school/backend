...
@TypeGraphQL.InputType("Project_field_with_grade_restrictionCreateManyStudentInput", {
  isAbstract: true
})
export class Project_field_with_grade_restrictionCreateManyStudentInput {
