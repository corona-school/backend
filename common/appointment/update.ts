...
export async function updateAppointment(user: User, appointment: Appointment, appointmentUpdate: Partial<Appointment>) {
    ...
    if (updatedAppointment.appointmentType === AppointmentType.group) {
    ...
    } else if (updatedAppointment.appointmentType === AppointmentType.match) {
        ...
        throw new Error(`Unknown participant type ${updatedAppointment.appointmentType}`);
    }
