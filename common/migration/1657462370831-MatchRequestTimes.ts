...
export class MatchRequestTimes1657462370831 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "pupil"."coduToken" IS NULL`);
        await queryRunner.query(`ALTER TABLE "pupil" ALTER COLUMN "coduToken" SET DEFAULT null`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "match"."dissolveReason" IS NULL`);
        await queryRunner.query(`ALTER TABLE "pupil" ALTER COLUMN "coduToken" DROP DEFAULT`);
        await queryRunner.query(`COMMENT ON COLUMN "pupil"."coduToken" IS NULL`);
