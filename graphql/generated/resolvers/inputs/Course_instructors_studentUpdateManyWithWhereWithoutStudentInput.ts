...
@TypeGraphQL.InputType("Course_instructors_studentUpdateManyWithWhereWithoutStudentInput", {
  isAbstract: true
})
export class Course_instructors_studentUpdateManyWithWhereWithoutStudentInput {
